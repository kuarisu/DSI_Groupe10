...
////// Emissive:
                ...
                float3 emissive = (_MainTex_var.rgb*lerp(_ColorFull.rgb,_ColorEmpty.rgb,(1.0 - node_2462))*(saturate(round(((node_2462*1.0+-0.5)+node_6610)))*round(saturate((abs(sin((node_6610*__Max_Ammor*3.14159)))+_Graduation_Thickness)))));
